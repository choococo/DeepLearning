...
class Detector:
    ...
    def __init__(self, p_net_param=r"utils\params_p/p_net_52_s.pth",
                 # 61，
                 r_net_param="utils/params_r/r_net_61.pth",
                 o_net_param=r"utils/params_o/o_net_104.pth", isCuda=False):
        self.isCuda = isCuda

...
while (n < 3000):
    ...
    # 获取正则匹配到的结果，返回list
    s = p.findall(html)
    if os.path.isdir(r"F:\2.Dataset\Yellow\photo3") != True:
        os.makedirs(r"F:\2.Dataset\Yellow\photo3")
    with open("testpic.txt", "a") as f:
        ...
        for i in s:
            ...
            f.write("\n")
            # 保存图片
            urllib.request.urlretrieve(i, r"F:\2.Dataset\Yellow\photo3/pic{num}.jpg".format(num=j))
            j += 1
            print(j)
        f.close()
